...
const Cine = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de cine...');
        const eventosCine = await getEventosPorCategoria("Cine");
        console.log('Respuesta del servidor:', eventosCine);
        ...
        if (!Array.isArray(eventosCine)) {
          console.error('La respuesta no es un array:', eventosCine);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de cine cargados:', eventosCine);
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          ...
          <p className="seccion-descripcion">Descubre los mejores estrenos y películas</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos de cine disponibles en este momento</p>
