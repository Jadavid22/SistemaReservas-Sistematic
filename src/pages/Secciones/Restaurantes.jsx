...
const Restaurantes = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de restaurantes...');
        const eventosRestaurantes = await getEventosPorCategoria("Restaurantes");
        console.log('Respuesta del servidor:', eventosRestaurantes);
        ...
        if (!Array.isArray(eventosRestaurantes)) {
          console.error('La respuesta no es un array:', eventosRestaurantes);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de restaurantes cargados:', eventosRestaurantes);
