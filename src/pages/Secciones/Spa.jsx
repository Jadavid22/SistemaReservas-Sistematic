...
const Spa = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de spa...');
        const eventosSpa = await getEventosPorCategoria("Spa");
        console.log('Respuesta del servidor:', eventosSpa);
        ...
        if (!Array.isArray(eventosSpa)) {
          console.error('La respuesta no es un array:', eventosSpa);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de spa cargados:', eventosSpa);
        setEventos(eventosSpa);
      } catch (error) {
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Spa</h1>
          <p className="seccion-descripcion">Descubre los mejores tratamientos y experiencias de spa</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos de spa disponibles en este momento</p>
