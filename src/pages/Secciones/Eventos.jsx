  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        ...
        const eventosGenerales = await getEventosPorCategoria("Eventos");
        console.log('Respuesta del servidor:', eventosGenerales);
        ...
        if (!Array.isArray(eventosGenerales)) {
          console.error('La respuesta no es un array:', eventosGenerales);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos cargados:', eventosGenerales);
        setEventos(eventosGenerales);
      } catch (error) {
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          ...
          <p className="seccion-descripcion">Descubre los mejores eventos y experiencias</p>
        </div>
