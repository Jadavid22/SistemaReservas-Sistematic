...
const Cultura = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos culturales...');
        const eventosCultura = await getEventosPorCategoria("Cultura");
        console.log('Respuesta del servidor:', eventosCultura);
        ...
        if (!Array.isArray(eventosCultura)) {
          console.error('La respuesta no es un array:', eventosCultura);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos culturales cargados:', eventosCultura);
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Cultura</h1>
          <p className="seccion-descripcion">Descubre los mejores eventos culturales y experiencias</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos culturales disponibles en este momento</p>
              <p className="no-eventos-sub">¡Vuelve pronto para ver nuevos eventos culturales!</p>
            </div>
          )}
        </div>
