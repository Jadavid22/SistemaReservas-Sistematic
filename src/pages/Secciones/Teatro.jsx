...
const Teatro = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de teatro...');
        const eventosTeatro = await getEventosPorCategoria("Teatro");
        console.log('Respuesta del servidor:', eventosTeatro);
        ...
        if (!Array.isArray(eventosTeatro)) {
          console.error('La respuesta no es un array:', eventosTeatro);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de teatro cargados:', eventosTeatro);
        setEventos(eventosTeatro);
      } catch (error) {
    ...
    return (
      <div className="app-container">
        ...
        <div className="loading-container">
          ...
          <p>Cargando eventos de teatro...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Teatro</h1>
          <p className="seccion-descripcion">Descubre las mejores obras de teatro y espectáculos</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos de teatro disponibles en este momento</p>
