  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        ...
        const eventosDestinos = await getEventosPorCategoria("Destinos");
        console.log('Respuesta del servidor:', eventosDestinos);
        ...
        if (!Array.isArray(eventosDestinos)) {
          console.error('La respuesta no es un array:', eventosDestinos);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Destinos cargados:', eventosDestinos);
        setEventos(eventosDestinos);
      } catch (error) {
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Destinos</h1>
          <p className="seccion-descripcion">Descubre los mejores destinos y lugares para visitar</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              ...
              <p className="no-eventos-sub">¡Vuelve pronto para ver nuevos destinos!</p>
            </div>
          )}
        </div>
