...
const Restaurante = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de restaurante...');
        const eventosRestaurante = await getEventosPorCategoria("Restaurante");
        console.log('Respuesta del servidor:', eventosRestaurante);
        
        if (!eventosRestaurante) {
          console.warn('No se recibieron eventos del servidor');
          setEventos([]);
          return;
        }

        if (!Array.isArray(eventosRestaurante)) {
          console.error('La respuesta no es un array:', eventosRestaurante);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de restaurante cargados:', eventosRestaurante);
        setEventos(eventosRestaurante);
      } catch (error) {
    ...
    return (
      <div className="app-container">
        ...
        <div className="loading-container">
          ...
          <p>Cargando eventos de restaurante...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Restaurante</h1>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos de restaurante disponibles en este momento</p>
