...
const Picnic = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de picnic...');
        const eventosPicnic = await getEventosPorCategoria("Picnic");
        console.log('Respuesta del servidor:', eventosPicnic);
        ...
        if (!Array.isArray(eventosPicnic)) {
          console.error('La respuesta no es un array:', eventosPicnic);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de picnic cargados:', eventosPicnic);
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          ...
          <p className="seccion-descripcion">Descubre los mejores lugares para picnic y actividades al aire libre</p>
        </div>
