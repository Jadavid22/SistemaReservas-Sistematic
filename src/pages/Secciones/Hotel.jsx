...
const Hotel = () => {
  ...
  useEffect(() => {
    const cargarEventos = async () => {
      try {
        setLoading(true);
        console.log('Iniciando carga de eventos de hotel...');
        const eventosHotel = await getEventosPorCategoria("Hotel");
        console.log('Respuesta del servidor:', eventosHotel);
        ...
        if (!Array.isArray(eventosHotel)) {
          console.error('La respuesta no es un array:', eventosHotel);
          setError('Error en el formato de los datos recibidos');
          return;
        }

        console.log('Eventos de hotel cargados:', eventosHotel);
        setEventos(eventosHotel);
      } catch (error) {
    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          <h1 className="seccion-titulo">Hotel</h1>
          <p className="seccion-descripcion">Descubre los mejores hoteles y experiencias de alojamiento</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay eventos de hotel disponibles en este momento</p>
