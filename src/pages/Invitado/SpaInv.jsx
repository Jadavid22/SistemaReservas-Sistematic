    ...
    <div className="app-container">
      ...
      <main className="seccion-container">
        <div className="seccion-header">
          ...
          <p className="seccion-descripcion">Descubre los mejores servicios de spa y bienestar</p>
        </div>
        ...
        <div className="eventos-grid">
          {eventos && eventos.length > 0 ? (
            ...
            <div className="no-eventos">
              <p>No hay servicios de spa disponibles en este momento</p>
              <p className="no-eventos-sub">¡Vuelve pronto para ver nuevos servicios!</p>
            </div>
          )}
        </div>
      </main>
